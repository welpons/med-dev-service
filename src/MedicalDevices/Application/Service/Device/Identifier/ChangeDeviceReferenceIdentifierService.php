...
/**
 * This service allows to change reference device identifier of a device
 *
 * @author Welpons <welpons@gmail.com>
 */
class ChangeDeviceReferenceIdentifierService extends ApplicationService implements DeviceIdentifierServiceCommandInterface
{
    public function execute(ValidatorHandlerInterface $validatorHandler, DeviceIdentifierRequestDTO $dto)
    {
        ...
        $device->changeReferenceDeviceIdentifier($deviceIdentifier->identifier());
